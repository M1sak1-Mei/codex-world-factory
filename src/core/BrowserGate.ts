...
export function browserGate(): boolean {
  ...
  if (isMobileDevice()) {
    failLoud('A computer is required', [
      'Codex World Factory pushes desktop-class GPU work through WebGPU — phone and tablet',
  ...
  if (!isChromiumBrowser()) {
    failLoud('Google Chrome is required', [
      'Codex World Factory is built and tested against Chrome’s WebGPU implementation.',
